		...
		<div class="row">
			<div class="col-lg-12">
				<div class="footer-col first">
					<h6>About Website</h6>
					<p class="p-small">Proin ut felis purus vestibulum in orci
						molestie, efficitur lacus ac pellentesque elit. Fusce mollis
						laoreet lobortis nulla ac efficitur lacus ac</p>
				</div>
				<!-- end of footer-col -->
				...
				<div class="footer-col third">
					...
					<p class="p-small">
						Quam posuerei pellent esque vam <a href="mailto:contact@site.com"><strong>contact@site.com</strong></a>
					</p>
				</div>
				<!-- end of footer-col -->
			</div>
